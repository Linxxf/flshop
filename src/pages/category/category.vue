...
import { ref } from 'vue'
import { getBannerInfo } from '@/services/home.ts'
...
onLoad(async () => {
  ...
  await Promise.allSettled([bannerInfo(), categoryInfo()])
...
<template>
  ...
  <view class="viewport" v-else>
    ...
    <view class="categories">
      ...
      >
        <!-- 焦点图 -->
        <flsSwiper class="banner" :banner="banner" />
        <!-- 内容区域 -->
        <view class="panel" v-for="items in item.children" :key="items.id">
          <view class="title">
